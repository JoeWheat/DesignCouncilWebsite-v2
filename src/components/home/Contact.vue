        ...
        <div class="col-md-7 mt-3 mt-md-0">
          <div class="box">
            <form class="box-form" method="post" data-netlify="true">
              ...
              <div data-netlify="true" class="box-btn mt-4">
                <button class="btn-dc" type="submit">
                  Send<span
                    class="btn-overlay"
                    style="top: 50px; left: 64px;"
                  ></span>
                </button>
              </div>
            </form>
...
.custom-control-input:disabled ~ .custom-control-label::before {
  background-color: rgba(247, 246, 249, 0.8);
}
...
.custom-checkbox .custom-control-input:checked ~ .custom-control-label::after {
  background-image: url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' viewBox='0 0 11 8'%3e%3cpath fill='transparent' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' stroke='%23322153' d='M10 1L4 7L1 4'/%3e%3c/svg%3e");
}
...
.custom-radio .custom-control-input:checked ~ .custom-control-label::after {
  background-image: url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' viewBox='-3 -3 6 6'%3e%3ccircle r='3' fill='%23322153'/%3e%3c/svg%3e");
}
...
.custom-select:focus {
  border-color: #e9e9eb;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(0, 242, 169, 0.25);
}
...
.custom-select-lg {
  height: 3.39973rem;
  padding-top: 0.75625rem;
  padding-bottom: 0.75625rem;
  padding-left: 1.16875rem;
  font-size: 1.2375rem;
}
...
.col-form-label {
  padding-top: calc(0.6875rem + 3px);
  padding-bottom: calc(0.6875rem + 3px);
  margin-bottom: 0;
  font-size: inherit;
  line-height: 1.222;
}
...
.col-form-label-lg {
  padding-top: calc(0.75625rem + 3px);
  padding-bottom: calc(0.75625rem + 3px);
  font-size: 1.2375rem;
  line-height: 1.222;
}
...
.form-control.is-valid {
  border-color: #77ba21;
  padding-right: calc(1.222em + 1.375rem);
  ...
  background-position: center right calc(0.3055em + 0.34375rem);
  background-size: calc(0.611em + 0.6875rem) calc(0.611em + 0.6875rem);
}
...
textarea.form-control.is-valid {
  padding-right: calc(1.222em + 1.375rem);
  background-position: top calc(0.3055em + 0.34375rem) right
    calc(0.3055em + 0.34375rem);
}
...
.custom-select.is-valid {
  ...
  background: url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23192031' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e")
      no-repeat right 1.0625rem center/8px 10px,
    url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2377BA21' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e")
      #f7f6f9 no-repeat center right 2.0625rem / calc(0.611em + 0.6875rem)
      calc(0.611em + 0.6875rem);
}
...
.custom-select.is-invalid {
  ...
  background: url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23192031' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e")
      no-repeat right 1.0625rem center/8px 10px,
    url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' fill='%23E72660' viewBox='-2 -2 7 7'%3e%3cpath stroke='%23E72660' d='M0 0l3 3m0-3L0 3'/%3e%3ccircle r='.5'/%3e%3ccircle cx='3' r='.5'/%3e%3ccircle cy='3' r='.5'/%3e%3ccircle cx='3' cy='3' r='.5'/%3e%3c/svg%3E")
      #f7f6f9 no-repeat center right 2.0625rem / calc(0.611em + 0.6875rem)
      calc(0.611em + 0.6875rem);
}
...
.popup-newsletter-right .custom-control-label:before {
  border-color: transparent;
